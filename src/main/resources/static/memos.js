...
function renderMemos(memos) {
  ...
  if (memos.length === 0) {
    memoList.append(createTextElement('li', i18n.t('memos_empty')));
    return;
  }
  ...
  memos.forEach((memo) => {
    ...
    const meta = createTextElement('div', i18n.t('memos_created', { time: toLocalTime(memo.createdAt) }), 'item-meta');
